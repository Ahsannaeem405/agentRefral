...
!(function () {
    function e(e, t) {
        var n = parseInt(e, 10);
        return isNaN(n) ? 0 : "string" == typeof e && e.indexOf("%") !== -1 ? (n / 100) * t : n;
    }
    function t(t) {
        var n = t[s],
            r = t.chart.canvas;
    ...
    function n(e) {
        ...
        return (
            ...
            { enabled: r(n.enabled, t.enabled), xOffset: r(n.xOffset, t.xOffset), yOffset: r(n.yOffset, t.yOffset), delay: r(n.delay, t.delay), appeared: !1, delayed: !1, loaded: !1, elements: [] }
        );
    }
    function r(e) {
        var n = e.target,
        ...
        r.ticking ||
            ...
            l.platform.defer(function () {
                var e,
                    ...
                    a = r.instances.slice(),
                    f = a.length;
                for (n = 0; n < f; ++n) (e = a[n]), t(e) && (d(e), (e[s].appeared = !0), e.update());
                r.ticking = !1;
            }));
    }
    function a(e) {
    ...
    function f(e) {
        for (var t, n, f = e.chart.canvas, d = f.parentElement; d; )
            a(d) && ((t = d[i] || (d[i] = {})), (n = t.instances || (t.instances = [])), 0 === n.length && d.addEventListener("scroll", r, { passive: !0 }), n.push(e), e[s].elements.push(d)), (d = d.parentElement || d.ownerDocument);
    }
    function d(e) {
