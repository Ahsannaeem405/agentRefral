                    ...
                    (o.prototype = {
                        ...
                        luminosity: function () {
                            for (var t = this.values.rgb, e = [], a = 0; a < t.length; a++) {
                                var i = t[a] / 255;
                                e[a] = i <= 0.03928 ? i / 12.92 : Math.pow((i + 0.055) / 1.055, 2.4);
                            }
            ...
            4: [
                function (t, e, a) {
                        ...
                        return [
                            100 *
                                (0.4124 * (e = e > 0.04045 ? Math.pow((e + 0.055) / 1.055, 2.4) : e / 12.92) +
                                    0.3576 * (a = a > 0.04045 ? Math.pow((a + 0.055) / 1.055, 2.4) : a / 12.92) +
                                    0.1805 * (i = i > 0.04045 ? Math.pow((i + 0.055) / 1.055, 2.4) : i / 12.92)),
                            100 * (0.2126 * e + 0.7152 * a + 0.0722 * i),
                            100 * (0.0193 * e + 0.1192 * a + 0.9505 * i),
                        ];
                    }
                    function d(t) {
                        var e,
                    ...
                    function c(t) {
                        ...
                        (e = 2 * l - (a = l < 0.5 ? l * (1 + s) : l + s - l * s)), (n = [0, 0, 0]);
                    ...
                    function m(t) {
                        var e,
                            ...
                            r = t[2] / 100;
                        return (
                            (e = 3.2406 * n + -1.5372 * o + -0.4986 * r),
                            (a = -0.9689 * n + 1.8758 * o + 0.0415 * r),
                            (i = 0.0557 * n + -0.204 * o + 1.057 * r),
                    ...
                    function x(t) {
                        var e,
                            ...
                            s = t[2];
                        return (
                            o <= 8 ? (n = ((a = (100 * o) / 903.3) / 100) * 7.787 + 16 / 116) : ((a = 100 * Math.pow((o + 16) / 116, 3)), (n = Math.pow(a / 100, 1 / 3))),
                            (e = e / 95.047 <= 0.008856 ? (e = (95.047 * (r / 500 + n - 16 / 116)) / 7.787) : 95.047 * Math.pow(r / 500 + n, 3)),
                            (i = i / 108.883 <= 0.008859 ? (i = (108.883 * (n - s / 200 - 16 / 116)) / 7.787) : 108.883 * Math.pow(n - s / 200, 3)),
                            [e, a, i]
                        );
                    }
                    function y(t) {
                            ...
                            (t.controllers.bar = t.DatasetController.extend({
                                        ...
                                        e.each(
                                            ...
                                            function (e, a) {
                                                ...
                                                o.bar &&
                                                    ...
                                                    (!1 === i.options.stacked || (!0 === i.options.stacked && -1 === n.indexOf(o.stack)) || (void 0 === i.options.stacked && (void 0 === o.stack || -1 === n.indexOf(o.stack)))) &&
                                                    n.push(o.stack);
                                            },
                                            t
                                        ),
                                ...
                                getStackIndex: function (t) {
                                    var e,
                                        ...
                                        r = [n.stack];
                                    for (a = 0; a < t; ++a)
                                        (e = this.chart.getDatasetMeta(a)).bar &&
                                            this.chart.isDatasetVisible(a) &&
                                            (!1 === o.options.stacked || (!0 === o.options.stacked && -1 === r.indexOf(e.stack)) || (void 0 === o.options.stacked && (void 0 === e.stack || -1 === r.indexOf(e.stack)))) &&
                                            r.push(e.stack);
                                    return r.length - 1;
                                },
                            ...
                            (t.controllers.bubble = t.DatasetController.extend({
                                ...
                                updateElement: function (a, i, n) {
                                    ...
                                    e.extend(a, {
                                        ...
                                        _index: i,
                                        _model: {
                                            x: n ? s.getPixelForDecimal(0.5) : s.getPixelForValue("object" == typeof c ? c : NaN, i, f, o.chart.isCombo),
                            ...
                            (t.controllers.doughnut = t.controllers.pie = t.DatasetController.extend({
                                ...
                                update: function (t) {
                                    ...
                                    if (f < 2 * Math.PI) {
                                        var g = o.rotation % (2 * Math.PI),
                                            ...
                                            C = { width: 0.5 * (w.x - M.x), height: 0.5 * (w.y - M.y) };
                                        (u = Math.min(s / C.width, l / C.height)), (d = { x: -0.5 * (w.x + M.x), y: -0.5 * (w.y + M.y) });
                                    }
                                ...
                                updateElement: function (t, a, i) {
                                    ...
                                    e.extend(t, {
                                        ...
                                        _index: a,
                                        _model: { x: u + o.offsetX, y: d + o.offsetY, startAngle: c, endAngle: h, circumference: g, outerRadius: m, innerRadius: p, label: v(f.label, a, o.data.labels[a]) },
                                    });
                                    var b = t._model;
                            ...
                            (t.controllers.line = t.DatasetController.extend({
                                ...
                                updateElement: function (t, e, i) {
                                    ...
                                    void 0 !== u.radius && void 0 === u.pointRadius && (u.pointRadius = u.radius),
                                        ...
                                        (n = f.getPixelForValue("object" == typeof c ? c : NaN, e, d, p)),
                                ...
                                updateBezierControlPoints: function () {
                                    ...
                                    if (
                                        ...
                                        for (e = 0, i = u.length; e < i; ++e)
                                            (n = u[e]._model),
                                                (o = a.splineCurve(a.previousItem(u, e)._model, n, a.nextItem(u, e)._model, s.dataset._model.tension)),
                                    ...
                                    if (r.chart.options.elements.line.capBezierPoints)
                                        for (e = 0, i = u.length; e < i; ++e)
                                            ((n = u[e]._model).controlPointPreviousX = t(n.controlPointPreviousX, l.left, l.right)),
                                                (n.controlPointPreviousY = t(n.controlPointPreviousY, l.top, l.bottom)),
                                                (n.controlPointNextX = t(n.controlPointNextX, l.left, l.right)),
                                                (n.controlPointNextY = t(n.controlPointNextY, l.top, l.bottom));
                                },
                                draw: function (a) {
                                    var i,
                                        n,
                                    ...
                                    for (
                                        t.canvasHelpers.clipArea(o.chart.chart.ctx, o.chart.chartArea),
                            ...
                            (t.controllers.polarArea = t.DatasetController.extend({
                                ...
                                updateElement: function (t, a, i) {
                                    ...
                                    e.extend(t, {
                                        ...
                                        _index: a,
                                        _scale: u,
                                        _model: { x: f, y: g, innerRadius: 0, outerRadius: i ? S : x, startAngle: i && l.animateRotate ? b : y, endAngle: i && l.animateRotate ? b : k, label: d(c, a, c[a]) },
                                    }),
                            ...
                            i.extend(t.Controller.prototype, {
                                ...
                                buildScales: function () {
                                    ...
                                    a.scales &&
                                        ...
                                        a.scale && o.push({ options: a.scale, dtype: "radialLinear", isDefault: !0 }),
                                        i.each(o, function (a) {
                                            var o = a.options,
                                ...
                                update: function (t, e) {
                                    ...
                                    if ((a(o), !1 !== n.notify(o, "beforeUpdate"))) {
                                        ...
                                        i.each(
                                            ...
                                            o._bufferedRender ? (o._bufferedRequest = { lazy: e, duration: t }) : o.render(t, e);
                                    }
                                },
                                ...
                                drawDatasets: function (t) {
                                    var e = this;
                                    !1 !== n.notify(e, "beforeDatasetsDraw", [t]) &&
                                        (i.each(
                                            e.data.datasets,
                                            function (a, i) {
                                    ...
                                    (i = r[e]),
                                        ...
                                        i.model.skip ||
                                            ...
                                            (o.almostEquals(i.deltaK, 0, this.EPSILON)
                                                ? (i.mK = n.mK = 0)
                                                : ((u = i.mK / i.deltaK), (d = n.mK / i.deltaK), (h = Math.pow(u, 2) + Math.pow(d, 2)) <= 9 || ((c = 3 / Math.sqrt(h)), (i.mK = u * c * i.deltaK), (n.mK = d * c * i.deltaK))));
                                var f;
                                for (e = 0; e < s; ++e)
                                    (i = r[e]).model.skip ||
                                        ((a = e > 0 ? r[e - 1] : null),
                                        (n = e < s - 1 ? r[e + 1] : null),
                                        a && !a.model.skip && ((f = (i.model.x - a.model.x) / 3), (i.model.controlPointPreviousX = i.model.x - f), (i.model.controlPointPreviousY = i.model.y - f * i.mK)),
                                        n && !n.model.skip && ((f = (n.model.x - i.model.x) / 3), (i.model.controlPointNextX = i.model.x + f), (i.model.controlPointNextY = i.model.y + f * i.mK)));
                            }),
                            ...
                            easeInOutElastic: function (t) {
                                ...
                                return 0 === t
                                    ...
                                    : (a || (a = 0.3 * 1.5 * 1),
                                      ...
                                      t < 1 ? i * Math.pow(2, 10 * (t -= 1)) * Math.sin(((1 * t - e) * (2 * Math.PI)) / a) * -0.5 : i * Math.pow(2, -10 * (t -= 1)) * Math.sin(((1 * t - e) * (2 * Math.PI)) / a) * 0.5 + 1);
                            },
                        ...
                        function a(t, e) {
                            ...
                            for (i = 0, o = t.data.datasets.length; i < o; ++i)
                                if (t.isDatasetVisible(i))
                                    for (n = 0, r = (a = t.getDatasetMeta(i)).data.length; n < r; ++n) {
                                        var s = a.data[n];
                                        s._view.skip || e(s);
                                    }
                        }
                    ...
                    e.exports = function (t) {
                        ...
                        t.layoutService = {
                            ...
                            update: function (t, a, i) {
                                ...
                                function o(t) {
                                    t.isHorizontal()
                                        ? ((t.left = t.options.fullWidth ? l : T), (t.right = t.options.fullWidth ? a - u : T + S), (t.top = z), (t.bottom = z + t.height), (z = t.bottom))
                                        : ((t.left = B), (t.right = B + t.width), (t.top = _), (t.bottom = _ + M), (B = t.right));
                                }
                                if (t) {
                                    ...
                                    e.each(h.concat(f, g, p), function (t) {
                                        var e,
                                            a = t.isHorizontal();
                                        a ? ((e = t.update(t.options.fullWidth ? v : S, k)), (M -= e.height)) : ((e = t.update(y, x)), (S -= e.width)), w.push({ horizontal: a, minSize: e, box: t });
                                    });
                                    var C = 0,
                                        I = 0,
                                        D = 0,
                                    ...
                                    e.each(h.concat(g), o),
                                        ...
                                        e.each(f, o),
                                        e.each(p, o),
                                        (t.chartArea = { left: T, top: _, right: T + S, bottom: _ + M }),
                                        e.each(m, function (e) {
                                        ...
                                        if (((s.font = f), m)) {
                                            ...
                                            (s.textAlign = "left"),
                                                ...
                                                i.each(a.legendItems, function (t, i) {
                                                    ...
                                                    v[v.length - 1] + n + o.padding >= a.width && ((b += d + o.padding), (v[v.length] = a.left)), (g[i] = { left: 0, top: 0, width: n, height: d }), (v[v.length - 1] += n + o.padding);
                                                }),
                                                (p.height += b);
                                        } else {
                                            var x = o.padding,
                                            ...
                                            i.each(a.legendItems, function (t, a) {
                                                ...
                                                M + w > p.height && ((k += S + o.padding), y.push(S), (S = 0), (M = 0)), (S = Math.max(S, i)), (M += w), (g[a] = { left: 0, top: 0, width: i, height: d });
                                            }),
                                                (k += S),
                                                y.push(S),
                                                (p.width += k);
                                    ...
                                    if (n.display) {
                                        ...
                                        i.each(a.legendItems, function (t, e) {
                                            var i = c.measureText(t.text).width,
                                                ...
                                                s = d.y;
                                            S
                                                ? r + n >= l && ((s = d.y += M), d.line++, (r = d.x = a.left + (l - u[d.line]) / 2))
                                                : s + M > a.bottom && ((r = d.x = r + a.columnWidths[d.line] + o.padding), (s = d.y = a.top + o.padding), d.line++),
                                                y(r, s, t),
                                                (x[e].left = r),
                                                (x[e].top = s),
                                                k(r, s, t, i),
                                    ...
                                    return (
                                        this._plugins.concat(r.plugins || []).forEach(function (t) {
                                            if (-1 === n.indexOf(t)) {
                                                var a = t.id,
                                                    i = l[a];
                                                !1 !== i && (!0 === i && (i = e.clone(s[a])), n.push(t), o.push({ plugin: t, options: i || {} }));
                                            }
                                        }),
                                        (i.descriptors = o),
                                        (i.id = this._cacheId),
                            ...
                            (t.Scale = t.Element.extend({
                                ...
                                update: function (t, e, a) {
                                    ...
                                    return (
                                        ...
                                        (n.maxWidth = t),
                                        (n.maxHeight = e),
                                        (n.margins = i.extend({ left: 0, right: 0, top: 0, bottom: 0 }, a)),
                                ...
                                calculateTickRotation: function () {
                                    ...
                                    if (t.options.display && t.isHorizontal())
                                        for (var s, l = i.longestText(e, o.font, t.ticks, t.longestTextCache), u = l, d = t.getPixelForTick(1) - t.getPixelForTick(0) - 6; u > d && r < n.maxRotation; ) {
                                            var c = i.toRadians(r);
                                ...
                                fit: function () {
                                    ...
                                    if (
                                        ((n.width = d ? (t.isFullWidth() ? t.maxWidth - t.margins.left - t.margins.right : t.maxWidth) : u && l.drawTicks ? f : 0),
                                        (n.height = d ? (u && l.drawTicks ? f : 0) : t.maxHeight),
                                        ...
                                        if (d) {
                                            ...
                                            var y = t.ticks[0],
                                                ...
                                                M = e(t.ctx, S, c.font);
                                            0 !== t.labelRotation
                                                ? ((t.paddingLeft = "bottom" === o.position ? b * k + 3 : b * m + 3), (t.paddingRight = "bottom" === o.position ? b * m + 3 : b * M + 3))
                                                : ((t.paddingLeft = k / 2 + 3), (t.paddingRight = M / 2 + 3));
                                    ...
                                    if (o.display) {
                                        ...
                                        if (p) {
                                            if (
                                                ((r = !1),
                                                f && (C /= 2),
                                                (C + d.autoSkipPadding) * n.ticks.length > n.width - (n.paddingLeft + n.paddingRight) &&
                                                    (r = 1 + Math.floor(((C + d.autoSkipPadding) * n.ticks.length) / (n.width - (n.paddingLeft + n.paddingRight)))),
                                                s && n.ticks.length > s)
                                            )
                                        ...
                                        if (
                                            (i.each(n.ticks, function (t, a) {
                                                if (void 0 !== t && null !== t) {
                                                    ...
                                                    if ((!((r > 1 && a % r > 0) || (a % r == 0 && a + r >= n.ticks.length)) || s) && void 0 !== t && null !== t) {
                                                        var l, u;
                                                        a === (void 0 !== n.zeroLineIndex ? n.zeroLineIndex : 0)
                                                            ? ((l = c.zeroLineWidth), (u = c.zeroLineColor))
                                                            : ((l = i.getValueAtIndexOrDefault(c.lineWidth, a)), (u = i.getValueAtIndexOrDefault(c.color, a)));
                                                        var h,
                                                            g,
                                                            m,
                                                            v,
                                                        ...
                                                        if (p) {
                                                            "bottom" === o.position
                                                                ? ((R = f ? "middle" : "top"), (V = f ? "right" : "center"), (F = n.top + b))
                                                                : ((R = f ? "middle" : "bottom"), (V = f ? "left" : "center"), (F = n.bottom - b));
                                            ...
                                            i.each(I, function (t) {
                                                if (
                                                    ...
                                                    var e = t.label;
                                                    if (i.isArray(e)) for (var a = 0, n = 0; a < e.length; ++a) l.fillText("" + e[a], 0, n), (n += 1.5 * v.size);
                                            ...
                                            if (p) (_ = n.left + (n.right - n.left) / 2), (F = "bottom" === o.position ? n.bottom - S.size / 2 : n.top + S.size / 2);
                                                ...
                                                (_ = R ? n.left + S.size / 2 : n.right - S.size / 2), (F = n.top + (n.bottom - n.top) / 2), (V = R ? -0.5 * Math.PI : 0.5 * Math.PI);
                                            }
                                        ...
                                        if (c.drawBorder) {
                                            ...
                                            p ? ((B = z = "top" === o.position ? n.bottom : n.top), (B += W), (z += W)) : ((O = L = "left" === o.position ? n.right : n.left), (O += W), (L += W)),
                                                l.beginPath(),
                                                l.moveTo(O, B),
                                                l.lineTo(L, z),
                                                l.stroke();
                        ...
                        t.Ticks = {
                            generators: {
                                ...
                                logarithmic: function (t, a) {
                                    ...
                                    0 === s
                                        ? ((i = Math.floor(e.log10(a.minNotZero))), (n = Math.floor(a.minNotZero / Math.pow(10, i))), o.push(s), (s = n * Math.pow(10, i)))
                                        : ((i = Math.floor(e.log10(s))), (n = Math.floor(s / Math.pow(10, i))));
                                    do {
                            ...
                            draw: function () {
                                ...
                                if (o.display) {
                                    ...
                                    (i.fillStyle = n(o.fontColor, r.defaultFontColor)),
                                        (i.font = f),
                                        e.isHorizontal()
                                            ? ((s = m + (b - m) / 2), (l = p + (v - p) / 2), (u = b - m))
                                            : ((s = "left" === o.position ? m + d / 2 : b - d / 2), (l = p + (v - p) / 2), (u = v - p), (g = Math.PI * ("left" === o.position ? -0.5 : 0.5))),
                                        i.save(),
                                        i.translate(s, l),
                                        i.rotate(g),
                                        (i.textAlign = "center"),
                ...
                function (t, e, a) {
                    ...
                    e.exports = function (t) {
                        ...
                        function o(t, e) {
                            ...
                            return (
                                (a.font = l.fontString(d, e._titleFontStyle, e._titleFontFamily)),
                                l.each(e.title, g),
                        ...
                        function s(t, e, a) {
                            var i = t.x,
                                ...
                                c = s + r;
                            return (
                                "right" === l ? (i -= e.width) : "center" === l && (i -= e.width / 2),
                            ...
                            (t.Tooltip = t.Element.extend({
                                ...
                                drawCaret: function (t, a, i) {
                                    var n,
                                        ...
                                        x = a.height;
                                    "center" === p
                                        ? ("left" === g ? ((o = (n = m) - h), (r = n)) : ((o = (n = m + b) + h), (r = n)), (s = (l = v + x / 2) - h), (u = l + h))
                                        : ("left" === g ? (r = (o = (n = m + f) + h) + h) : "right" === g ? (r = (o = (n = m + b - f) - h) - h) : ((n = (o = m + b / 2) - h), (r = o + h)),
                                          "top" === p ? ((l = (s = v) - h), (u = s)) : ((l = (s = v + x) + h), (u = s))),
                                ...
                                draw: function () {
                                    function t(t, e) {
                                        ...
                                        !0 === e._view.steppedLine
                                            ...
                                            : 0 === e._view.tension
                                            ? l.lineTo(a.x, a.y)
                                            : l.bezierCurveTo(t._view.controlPointNextX, t._view.controlPointNextY, a.controlPointPreviousX, a.controlPointPreviousY, a.x, a.y);
                                    }
                                    var i = this,
                                        n = i._view,
                                        o = n.spanGaps,
                                    ...
                                    if (u.length && n.fill) {
                                        for (l.beginPath(), c = 0; c < u.length; ++c)
                                            (h = u[c]),
                                                ...
                                                (g = h._view),
                                                0 === c
                                                    ? (s ? l.moveTo(r.x, r.y) : l.moveTo(g.x, r), g.skip || ((d = c), l.lineTo(g.x, g.y)))
                                                    : ((f = -1 === d ? f : u[d]),
                                                      g.skip
                                                          ? o || d !== c - 1 || (s ? l.lineTo(r.x, r.y) : l.lineTo(f._view.x, r))
                                                          : (d !== c - 1 ? (o && -1 !== d ? t(f, h) : s ? l.lineTo(g.x, g.y) : (l.lineTo(g.x, r), l.lineTo(g.x, g.y))) : t(f, h), (d = c)));
                                    ...
                                    for (
                                        ...
                                        (h = u[c]),
                                            (f = e.previousItem(u, c)),
                                            (g = h._view),
                                            0 === c ? g.skip || (l.moveTo(g.x, g.y), (d = c)) : ((f = -1 === d ? f : u[d]), g.skip || ((d !== c - 1 && !o) || -1 === d ? l.moveTo(g.x, g.y) : t(f, h), (d = c)));
                                    l.stroke(), l.restore();
                                },
                            }));
                    };
                ...
                function (t, e, a) {
                    ...
                    e.exports = function (t) {
                        ...
                        var a = t.helpers,
                            i = t.defaults.global,
                            n = i.defaultColor;
                        (i.elements.point = { radius: 3, pointStyle: "circle", backgroundColor: n, borderWidth: 1, borderColor: n, hitRadius: 1, hoverRadius: 4, hoverBorderWidth: 1 }),
                            (t.elements.Point = t.Element.extend({
                                ...
                                draw: function (e) {
                                    var o = this._view,
                                        ...
                                        f = 0;
                                    o.skip ||
                                        ((s.strokeStyle = o.borderColor || n),
                                        (s.lineWidth = a.getValueOrDefault(o.borderWidth, i.elements.point.borderWidth)),
                                        (s.fillStyle = o.backgroundColor || n),
                                        void 0 !== e &&
                                            (r.x < e.left || 1.01 * e.right < r.x || r.y < e.top || 1.01 * e.bottom < r.y) &&
                                            (r.x < e.left
                                                ? (f = (d - r.x) / (e.left - r.x))
                                                : 1.01 * e.right < r.x
                                                ? (f = (r.x - d) / (r.x - e.right))
                                                : r.y < e.top
                                                ? (f = (c - r.y) / (e.top - r.y))
                                                : 1.01 * e.bottom < r.y && (f = (r.y - c) / (r.y - e.bottom)),
                        ...
                        (i.elements.rectangle = { backgroundColor: i.defaultColor, borderWidth: 0, borderColor: i.defaultColor, borderSkipped: "bottom" }),
                            (t.elements.Rectangle = t.Element.extend({
                                draw: function () {
                                    ...
                                    if (
                                        (u.horizontal
                                            ? ((e = u.base), (a = u.x), (i = u.y - u.height / 2), (n = u.y + u.height / 2), (o = a > e ? 1 : -1), (r = 1), (s = u.borderSkipped || "left"))
                                            : ((e = u.x - u.width / 2), (a = u.x + u.width / 2), (i = u.y), (o = 1), (r = (n = u.base) > i ? 1 : -1), (s = u.borderSkipped || "bottom")),
                                        d)
                                    ) {
                    ...
                    e.exports = function (t) {
                        ...
                        t.LinearScaleBase = t.Scale.extend({
                            handleTickRangeOptions: function () {
                                ...
                                void 0 !== a.min ? (t.min = a.min) : void 0 !== a.suggestedMin && (t.min = Math.min(t.min, a.suggestedMin)),
                                    void 0 !== a.max ? (t.max = a.max) : void 0 !== a.suggestedMax && (t.max = Math.max(t.max, a.suggestedMax)),
                                    t.min === t.max && (t.max++, a.beginAtZero || t.min--);
                            },
                            getTickLimit: a,
                            ...
                            buildTicks: function () {
                                var a = this,
                                    i = a.options.ticks,
                                    n = a.getTickLimit(),
                                    o = { maxTicks: (n = Math.max(2, n)), min: i.min, max: i.max, stepSize: e.getValueOrDefault(i.fixedStepSize, i.stepSize) },
                        ...
                        var e = t.helpers,
                            ...
                            i = t.Scale.extend({
                                ...
                                getPixelForValue: function (t) {
                                    ...
                                    return (
                                        o.isHorizontal()
                                            ? ((n = e.log10(o.end) - e.log10(r)), 0 === s ? (i = o.left) : ((a = o.width), (i = o.left + (a / n) * (e.log10(s) - e.log10(r)))))
                                            : ((a = o.height),
                                              0 !== r || l.reverse
                                                  ? 0 === o.end && l.reverse
                                                      ? ((n = e.log10(o.start) - e.log10(o.minNotZero)),
                                                        (i = s === o.end ? o.top : s === o.minNotZero ? o.top + 0.02 * a : o.top + 0.02 * a + ((0.98 * a) / n) * (e.log10(s) - e.log10(o.minNotZero))))
                                                      : ((n = e.log10(o.end) - e.log10(r)), (a = o.height), (i = o.bottom - (a / n) * (e.log10(s) - e.log10(r))))
                                                  : ((n = e.log10(o.end) - e.log10(o.minNotZero)),
                                                    (i = s === r ? o.bottom : s === o.minNotZero ? o.bottom - 0.02 * a : o.bottom - 0.02 * a - ((0.98 * a) / n) * (e.log10(s) - e.log10(o.minNotZero))))),
                                        i
                                    );
                                },
                                getValueForPixel: function (t) {
            ...
            47: [
                function (t, e, a) {
                    ...
                    e.exports = function (t) {
                        ...
                        function l(t, e, a, i) {
                            if (f.isArray(e)) for (var n = a.y, o = 1.5 * i, r = 0; r < e.length; ++r) t.fillText(e[r], a.x, n), (n += o);
                            ...
                            var e = t.helpers,
                                ...
                                o = t.Scale.extend({
                                                        ...
                                                        ? e.each(
                                                              ...
                                                              function (e) {
                                                                  ...
                                                                  a.isValid() &&
                                                                      ...
                                                                      r.push(a),
                                                                      s && ((t.firstTick = null !== t.firstTick ? i.min(t.firstTick, a) : a), (t.lastTick = null !== t.lastTick ? i.max(t.lastTick, a) : a)));
                                                              },
                                                              t
                                                          )
                                                        : (r = a),
                                    ...
                                    buildTicks: function () {
                                        ...
                                        (0 === i.ticks[i.ticks.length - 1].diff(i.lastTick, i.tickUnit) && 0 !== i.scaleSizeInUnits) ||
                                            (i.options.time.max
