                            ...
                            $silver_gold=$orders2->where('get_refrral_count','<',$max_gold_id); $silver_gold=collect($silver_gold); $silver_gold_id=$silver_gold->max('get_refrral_count');
                                ...
                                @if($max_gold_id!=0)
                                    ...
                                    <tr class="event-item">
                                        ...
                                        <td class="add-event">
                                            @if($my_badge==1)
                                            <button type="button" class="btn btn-success get_rev_id" rec="{{$row_user->id}}" data-toggle="modal" data-target="#exampleModal">Send Referrals</button>
                                            @else
            ...
            <div class="modal-body">
                <form method="POST" action="{{ url('user/add/referral') }}">
                    ...
                    <div>
                        ...
                        <input type="hidden" name="reciver_id" class="reciver_id" value="{{$row_user->id}}">
