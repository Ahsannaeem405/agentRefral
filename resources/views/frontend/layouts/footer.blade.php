                ...
                <div class="col-xl-4 col-lg-4 col-md-6 col-12">
                    <div class="footer-widgets">
                        <div class="footer-logo">
                            <a href="index.html"> <img src="media/light.png" alt="logo" class="img-fluid" style="height:80px!important"></a>
                        </div>
                ...
                <div class="col-xl-4 col-lg-4 col-md-6 col-12">
                    <div class="footer-widgets">
                        ...
                        <ul class="footer-contact">
                            ...
                            <li><i class="flaticon-plane"></i>info@summitreferrals.com</li>
