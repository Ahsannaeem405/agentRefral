                            ...
                            <div class="translate-right-75 transition-150 opacity-animation transition-delay-100">
                                <div class="d-flex align-items-sm-center">
                                    ...
                                    <div class="item-content">
                                        ...
                                        <p>We are looking for One real estate agent per city.</p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="translate-right-75 transition-150 opacity-animation transition-delay-2000">
                                <div class="d-flex align-items-sm-center">
                                    ...
                                    <div class="item-content">
                                        ...
                                        <p>We approve of every single agent on our platform so you can be assured to not have any issues down the road</p>
                                    </div>
                                </div>
                            </div>
                        </li>
                        ...
                        <li>
                            <div class="translate-right-75 transition-150 opacity-animation transition-delay-100">
                                <div class="d-flex align-items-sm-center">
                                    ...
                                    <div class="item-content">
                                        <h3 class="item-title">Register Yourself</h3>
                                        <p>You need some basic information. you have to register your self as a agent.</p>
                                    </div>
                                </div>
                            </div>
                            <svg x="0px" y="0px" width="312px" height="130px">
                        ...
                        <li>
                            <div class="translate-left-75 transition-150 opacity-animation transition-delay-1000">
                                <div class="d-flex align-items-sm-center flex-xl-row-reverse">
                                    ...
                                    <div class="item-content">
                                        <h3 class="item-title">Become An Agent </h3>
                                        <p>After some verification. you will be the verified agent of our company from your own city </p>
                                    </div>
                                </div>
                            </div>
                            <svg x="0px" y="0px" width="312px" height="130px">
                        ...
                        <li>
                            <div class="translate-right-75 transition-150 opacity-animation transition-delay-2000">
                                <div class="d-flex align-items-sm-center">
                                    ...
                                    <div class="item-content">
                                        <h3 class="item-title">Work Across the Country</h3>
                                        <p>Work hard and you will be awarded with multiple tiers on the basis of your progress. </p>
                                    </div>
                                </div>
                            </div>
                        </li>
...
<section id="team-wrap-layout1" class="section-padding-md">
    <div class="container">
        <div class="section-heading heading-dark
            ...
            <h2 class="heading-main-title">Gold Agents</h2>
            <p class="heading-paragraph">Hard working and progressive people are the honour of our company</p>
        </div>
